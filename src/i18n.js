...
const resources = {
  en: {
    translation: {
      ...
      rating: "(06 Ratings)",
      rateForBusiness: "Rate This Business",
      viewLists: "View All Listings",
      enquiry: "Enquiry",
      specification: "Specifications",
      type: "Type",
      typeValue: "Landscape works",
      sqFt: "Sq. ft",
  ...
  ar: {
    translation: {
      ...
      rating: "(٠٦ تقييمات)",
      rateForBusiness: "قيم هذه الأعمال",
      viewLists: "عرض جميع القوائم",
      enquiry: "استفسار",
      specification: "المواصفات",
      type: "النوع",
      typeValue: "أعمال المناظر الطبيعية",
      sqFt: "قدم مربع",
