                    ...
                    <div className="flex gap-0 w-max">
                        ...
                        <div className={`relative bg-white  ${isArabic ? "rounded-r-lg" : "rounded-l-lg"} p-1`}>
                            <div className="flex items-center px-0 py-3">
                                <MapPin className="w-4 h-4 text-gray-500 mr-2" />
                                <select className="bg-transparent border-none outline-none text-gray-700 text-sm font-medium pr-6 w-full">
                                    {emirates.map((emirate, index) => (
                                        <option key={index} value={emirate}>{emirate}</option>
                                    ))}
                                </select>
                        ...
                        <div className="bg-white">
                            <input
                                type="text"
                                placeholder={t("banner.searchPlaceHolder") || "Search for anything"}
                                className="w-full px-4 py-3 bg-transparent border-none outline-none text-gray-700 text-sm placeholder-gray-500"
                            />
                        </div>
